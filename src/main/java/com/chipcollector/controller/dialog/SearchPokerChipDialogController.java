...
import com.chipcollector.controller.dashboard.MainWindowController;
...
public class SearchPokerChipDialogController implements Initializable {
    ...
    private void openNewPokerChipDialog(Window owner, PokerChipBean selectedPokerChip) {
        springFxmlLoader.<PokerChipDialogController>showDialog(MainWindowController.POKER_CHIP_ADD_DIALOG_FX_FILE_LOCATION,
