...
package com.chipcollector.views.control.moneyfield.skin;
    ...
    public MoneyFieldSkin(final MoneyField control) {
        ...
        textField = new TextField() {
            ...
            public void replaceText(int start, int end, String text) {
                ...
                replaceIfAcceptable(start, end, text, s -> super.replaceText(start, end, s));
            }
            ...
            public void replaceSelection(String text) {
                ...
                replaceIfAcceptable(start, end, text, super::replaceSelection);
            }

            private void replaceIfAcceptable(int start, int end, String text, Consumer<String> replaceFunction) {
                String t = Strings.nullToEmpty(textField.getText());
                t = t.substring(0, start) + text + t.substring(end);
                if (accept(t)) {
                    replaceFunction.accept(text);
                }
            }
        };
        ...
        control.getStyleClass().addListener(moneyFieldStyleClassListener =
                observable -> textField.getStyleClass().setAll(control.getStyleClass()));
        ...
        control.valueProperty().addListener(moneyFieldValueListener = observable -> {
        ...
        control.focusedProperty().addListener(moneyFieldFocusListener = observable -> {
            if (control.isFocused()) {
                textField.requestFocus();
            } else {
                System.out.println("Formattare correttamente");
            }
        });
